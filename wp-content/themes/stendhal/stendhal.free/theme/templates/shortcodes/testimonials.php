                ...
                <?php while( $tests->have_posts() ) : $tests->the_post();
                    ...
                    <div class="span3">
                        <div class="testimonial-circle-style">
                            ...
                            <?php if (yit_get_option('thumbnail-testimonials') && get_the_post_thumbnail( null, 'thumb-testimonial-circle' )) :  ?>
                                <div class="thumbnail">
                                    <?php echo get_the_post_thumbnail( null, 'thumb-testimonial-circle' ); ?>   
                                </div>
                            <?php endif ?>
