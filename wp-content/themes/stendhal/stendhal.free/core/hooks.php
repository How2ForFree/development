...
add_action( 'wp_footer'          , create_function( '', 'echo "<script type=\'text/javascript\'>" . yit_get_option( "google-analytics-code" ) . "</script>";' ), 10 );
add_action( 'wp_footer'          , create_function( '', 'echo "<script type=\'text/javascript\'>" . yit_get_option( "custom-script" ) . "</script>";' ), 11 );
...
if( isset( $_GET['page'] ) && $_GET['page'] == 'yit_panel_backup' ) {
    ...
    add_action( 'admin_print_scripts', 'yit_install_sampledata_ajax', 30 );
}
