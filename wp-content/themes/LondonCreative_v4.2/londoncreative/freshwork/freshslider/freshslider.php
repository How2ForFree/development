<?php
  ...
  //////////////////////////////////////////////////////////////////////////////  
  $slidername = 'Slider';  
  $slider_transitions = array ('random', 'basic', 'fly', 'flyback', 'lines');
...
<div class="wrap">
    ...
    <form id="post" method="post" action="?page=freshslider.php&fresh_slider=1" name="post">
                        ...
                        <tbody class="list:tag" id="the-list">
                            <tr class="alternate" id="tag-22">
                                ...
                                <td class="name column-name">
                                        ...
                                        <label for="fs_description">Description</label>
                                ...
                                <td class="name column-name" style="text-align:center;">
                                    <a href="?page=freshslider.php&remove_slider=<?php echo $row['id']; ?>"><img class="img_remove" src="<?php echo get_bloginfo('template_url')?>/freshwork/freshslider/gfx/remove.png"/></a>
                                </td>
                            </tr> 
