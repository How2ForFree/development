...
class Submenu_Widget extends WP_Widget {	
	...
	function form ( $instance ) { ?>
        ...
        <p>
			...
			<label for="<?php echo $this->get_field_id( 'show_stamp' ); ?>"><?php echo __( 'Show stamp' ); ?></label>
        </p> 
 
 		<p>
			<label for="<?php echo $this->get_field_id( 'link_stamp' ); ?>"><?php echo __( 'Link to' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'text_stamp' ); ?>"><?php echo __( 'Text for stamp' ); ?>:</label>
