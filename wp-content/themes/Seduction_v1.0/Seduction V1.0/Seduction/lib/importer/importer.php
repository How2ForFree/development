...
if($error !== false) {
	...
	if(!is_file($file)) {
	  ...
	  $screenoptions = array('_screen-payoffColor' => '00bbff', '_screen-home-bgType' => 'image', '_screen-home-bgImg' => 'lib/importer/dummy/gallery1.jpg', '_screen-logo-img' => 'lib/importer/dummy/seduction-logowhite.png', '_screen-twitter' => 'themedutch', '_screen-youtube' => 'themedutch', '_screen-galleryCategories' => '4', '_screen-sidebars' => serialize(array('contact')), '_screen-footermenus' => serialize(array('Footer')));
