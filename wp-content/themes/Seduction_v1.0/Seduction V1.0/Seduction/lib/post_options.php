...
function placeScreenOptions() {
  ...
  ?>>image</option>
  <option<?php
      if($bgType == "color") { echo ' selected'; }
  ?>>color</option>
  </select>
  <br /><span style="color:#999; font-size:10px;">Background Type: COLOR can be set under the Colors tab in the Seduction admin panel.</span>
  </td>
    </tr>
...
function teamDutchAddOptions() {
  add_meta_box('gallery_options', 'Full Screen Gallery options', 'placeScreenGalleryOptions', 'post', 'normal', 'high');
  add_meta_box('screen_options', 'Seduction page options', 'placeScreenOptions', 'page', 'normal', 'high');
  add_meta_box('screen_options', 'Seduction post options', 'placeScreenOptions', 'post', 'normal', 'high');  
  add_meta_box('grace_options', 'Grace Slider options', 'placeGraceOptions', 'page', 'normal', 'high');
  add_meta_box('grace_options', 'Grace Slider options', 'placeGraceOptions', 'post', 'normal', 'high');
}
?>