...
class GoogleSitemapGenerator {
	...
	var $_svnVersion = '$Id: sitemap-core.php 1.1 Rajesh Kumar $';
	...
	function BuildSitemap() {
		...
		$this->AddElement(new GoogleSitemapGeneratorDebugEntry("sitemap-generator-url=\"http://www.iwebslog.com\" sitemap-generator-version=\"" . $this->GetVersion() . "\""));
	...
	function GetRedirectLink($redir) {
		return trailingslashit("http://www.iwebslog.com/" . $redir);
	}
