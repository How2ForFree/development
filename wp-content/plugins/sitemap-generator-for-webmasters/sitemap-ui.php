...
class GoogleSitemapGeneratorUI {
	 ...
	 *
	 * This plugin will generate a special search engine compliant sitemap which will help search engines like Google, Yahoo, Bing and Ask.com to better index your blog.
	 */
	var $sg = null;
	...
	function HtmlShowOptionsPage() {
		...
		if(!empty($_REQUEST["sm_rebuild"])) { //Pressed Button: Rebuild Sitemap
			...
			if(isset($_GET["sm_do_debug"]) && $_GET["sm_do_debug"]=="true") {
				...
				echo '<div class="wrap">';
				echo '<h2>' .  __('Sitemap Generator for Webmasters.', 'sitemap') .  " " . $this->sg->GetVersion(). '</h2>';
		...
		<div class="wrap" id="sm_div">
				...
				<?php endif; ?>
					...
					<?php if(!$snl): ?>
							...
							<?php $this->HtmlPrintBoxHeader('sm_pnres',__('About this Plugin:','sitemap'),true); ?>
								<a class="sm_button sm_pluginHome"    href="http://www.iwebslog.com"><?php _e('Plugin Developer','sitemap'); ?></a>
								<a class="sm_button sm_pluginHome"    href="http://www.iwebslog.com/products/contact-us.html"><?php _e('Suggest a Feature','sitemap'); ?></a>
								<a class="sm_button sm_pluginList"    href="http://www.iwebslog.co.in/search-engine/seo-services2.aspx?prog_id=Iwebslog&pl_id=492308"><?php _e('Submit Website to Google','sitemap'); ?></a>
								<a class="sm_button sm_pluginSupport" href="http://www.iwebslog.co.in/search-engine/seo-services2.aspx?prog_id=Iwebslog&pl_id=492308"><?php _e('SEO Services','sitemap'); ?></a>
								<a class="sm_button sm_pluginBugs"    href="https://www.securepaynet.net/domains/search.aspx?prog_id=iwebslog&ci=1065"><?php _e('Register Domains','sitemap'); ?></a>

								<a class="sm_button sm_donatePayPal"  href="https://www.securepaynet.net/hosting/web-hosting.aspx?prog_id=iwebslog&ci=1070"><?php _e('WordPress Web Hosting','sitemap'); ?></a>
								<a class="sm_button sm_donateAmazon"  href="http://www.securepaynet.net/hosting/dedicated-servers.aspx?ci=1785&prog_id=Iwebslog"><?php _e('Dedicated Servers','sitemap'); ?></a>
								<?php if(__('translator_name','sitemap')!='translator_name') {?><a class="sm_button sm_pluginSupport" href="https://www.securepaynet.net/email/email-hosting.aspx?prog_id=iwebslog&ci=1072"><?php _e('Business Email','sitemap'); ?></a><?php } ?>
							<?php $this->HtmlPrintBoxFooter(true); ?>


							<?php $this->HtmlPrintBoxHeader('sm_smres',__('Sitemap Resources:','sitemap'),true); ?>
								<a class="sm_button sm_resGoogle"    href="http://www.iwebslog.com/products/security.html"><?php _e('SSL Certificates','sitemap'); ?></a>
								<a class="sm_button sm_resGoogle"    href="http://www.securepaynet.net/business/email-marketing.aspx?ci=42404&prog_id=Iwebslog"><?php _e('Email Marketing','sitemap'); ?></a>

								<a class="sm_button sm_resBing"      href="http://www.iwebslog.co.in/search-engine/seo-services2.aspx?prog_id=Iwebslog&pl_id=492308"><?php _e('Webmaster Tools','sitemap'); ?></a>
								<a class="sm_button sm_resBing"      href="http://www.iwebslog.com/products/shopping-cart.html"><?php _e('Open Online Store','sitemap'); ?></a>
								<br />
								<a class="sm_button sm_resGoogle"    href="http://www.iwebslog.co.in/search-engine/seo-services2.aspx?prog_id=Iwebslog&pl_id=492308"><?php _e('Search Engine Optimization','sitemap'); ?></a>
								<a class="sm_button sm_resGoogle"    href="http://www.iwebslog.com/products/international-domains.html"><?php _e('International Domains','sitemap'); ?></a>
								<a class="sm_button sm_pluginHome"   href="http://www.iwebslog.com/products/fax-thru-email.html"><?php _e('Online Faxing','sitemap'); ?></a>
							<?php $this->HtmlPrintBoxFooter(true); ?>
			...
			<input type="hidden" name="business" value="<?php echo "donate" /* N O S P A M */ . "@" . "support" . "iwebslog.com"; ?>" />		
