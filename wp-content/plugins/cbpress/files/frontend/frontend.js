...
jQuery(document).ready(function($) {
	...
	numcols = cbpressjs.catcols;
	$('.cbpressColumn').makeacolumnlists({cols: numcols, colWidth: 0, equalHeight: 'ul', startN: 1});

	
	$('.cbpressitem').click(function(){ 
		var a = $(this).find('a');
		var url = $(a).attr('href');
		target = ($(a).attr('target')) ? '_blank' : '_self';
		window.open(url, target); 
		return false; 
	});         
	$('.cbpressmall .item').click(function(){ 
		var a = $(this).find('a');
		var url = $(a).attr('href');
		target = ($(a).attr('target')) ? '_blank' : '_self';
		window.open(url, target); 
	...
	$('.cbpresslist .item').click(function(){ 
		var a = $(this).find('a');
		var url = $(a).attr('href');
		target = ($(a).attr('target')) ? '_blank' : '_self';
		window.open(url, target); 
	...
	$('.cbpresscat .item').click(function(){ 
		var a = $(this).find('a');
		var url = $(a).attr('href');
		target = ($(a).attr('target')) ? '_blank' : '_self';
		window.open(url, target); 
